 ...
 * SR Pin 14 to Arduino pin 2 | LILY PIN 0
 * SR Pin 12 to Arduino pin 3 | LILY PIN 1
 * SR Pin 11 to Arduino pin 4 | LILY PIN 2
 * SR Pin  8 to Ground
 * SR Pin 16 to +5v
 * SR Pin 13 to Ground
 * SR Pin 10 to +5v
...
int DATAPIN = 11;//SER   - Data
int CLOCKPIN = 12;//SCK  - Clock
int LATCHPIN = 13;//RCK  - Reset Clock
